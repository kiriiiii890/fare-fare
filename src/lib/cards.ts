...
export const cards = [
  ...
  { numeral: "37", name: "Hoa Linh Lan", file: "37-the-vakkey-lily.png", desc: "Lá bài đặc biệt — một điều ước thầm kín và một phép màu nhỏ đang chờ được khám phá. Hãy tin vào phần tinh khôi nhất trong bạn." },
] as const;
